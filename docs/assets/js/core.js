...
(function () {
  ...
  const I18N = {
    km: {
      ...
      'learn.expand': 'ពង្រីកពេញអេក្រង់',
      'learn.exitFull': 'ចេញពីពេញអេក្រង់',
      ...
      'quiz.wholeChapter': 'កម្រងសំណួរជំពូកទាំងមូល',
      'quiz.check': 'ពិនិត្យចម្លើយ',
      'quiz.hint': 'ចុច ១–៤ ដើម្បីជ្រើស រួច Enter ដើម្បីពិនិត្យ',
      'quiz.answer': 'ជម្រើសចម្លើយ',
      'quiz.rightCount': 'ត្រូវ',
      'quiz.wrongCount': 'ខុស',
      'quiz.noWrong': 'គ្មានសំណួរខុសទេ — ល្អណាស់!',
      'dash.more': 'ព័ត៌មានបន្ថែម',
      'dash.moreStats': 'ស្ថិតិបន្ថែម',
      'dash.bestScore': 'ពិន្ទុខ្ពស់បំផុត',
      'dash.quizzes': 'កម្រងសំណួរបានធ្វើ',
      'dash.notesCount': 'កំណត់សម្គាល់',
      'dash.cta': 'បន្តរៀន',
      'dash.avg': 'ពិន្ទុមធ្យម',
      'dash.avgOf': 'គិតលើកម្រងសំណួរ',
      'dash.avgNone': 'មិនទាន់ធ្វើកម្រងសំណួរទេ',
    ...
    en: {
      ...
      'learn.expand': 'Expand to full screen',
      'learn.exitFull': 'Exit full screen',
      ...
      'quiz.wholeChapter': 'Whole-chapter quiz',
      'quiz.check': 'Check answer',
      'quiz.hint': 'Press 1–4 to pick, then Enter to check',
      'quiz.answer': 'Answer options',
      'quiz.rightCount': 'Correct',
      'quiz.wrongCount': 'Wrong',
      'quiz.noWrong': 'Nothing wrong — perfect run!',
      'dash.more': 'More',
      'dash.moreStats': 'More stats',
      'dash.bestScore': 'Best score',
      'dash.quizzes': 'Quizzes taken',
      'dash.notesCount': 'Notes',
      'dash.cta': 'Continue learning',
      'dash.avg': 'Quiz average',
      'dash.avgOf': 'across',
      'dash.avgNone': 'No quizzes taken yet',
